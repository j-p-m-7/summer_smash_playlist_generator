...
if __name__ == '__main__':
    ...
    # artist_mbid = '0d051286-f737-464b-86a8-1e5ed6ceb2a2'
    # print(get_artist_setlists(artist_mbid))
...
#def create_artist_tracks_dict_sl(artist_dict):
    ...
    #artist_dict = {'Travis Scott': 'e4a51f17-a57b-47b1-b37b-f552d0f8e9e6', 'Big Sean': '942a9807-9c1a-4a0e-a285-1fde2c5be9d1'}
    #artist_dict = {'Clip': '0d051286-f737-464b-86a8-1e5ed6ceb2a2'}
    ...
    for index, (artist_name, artist_mbid) in enumerate(artist_dict.items()):
        ...
        if "code" not in artist_setlists:
                ...
                if value["setlist"][i]["sets"]["set"] != []:
                    ...
                    if 5 < len(value["setlist"][i]["sets"]["set"][0]["song"]) < 30:
                        ...
                        for song in value["setlist"][i]["sets"]["set"][0]["song"]:
                            ...
                            # Add song to songs list and avoid duplicates
            ...
            # Extract top 15-20 most common letters
            top_songs = list(sorted_song_counts.keys())[:20]

            # print("Top 15-20 most common letters:")
            # for song in top_songs:
            #     print(f"{song}: {sorted_song_counts[song]} occurrences")
